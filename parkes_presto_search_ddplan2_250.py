...
institution           = "MPIfR" 
base_output_directory = "/beegfsBN/miraculix2/part0/reatough/projects/Aswin/fake_spdata/"
...
ddplans.append(dedisp_plan( 114.0,  1.00,      76,     1,       96,       2))
ddplans.append(dedisp_plan( 190.0,  2.00,      76,     1,       96,       4))
ddplans.append(dedisp_plan( 342.0,  5.00,      64,     2,       96,       8))
ddplans.append(dedisp_plan( 982.0, 10.00,      64,     1,       96,       16))
ddplans.append(dedisp_plan(1622.0, 20.00,      64,     1,       96,       32))
ddplans.append(dedisp_plan(2902.0, 30.00,      76,     1,       96,       64))
